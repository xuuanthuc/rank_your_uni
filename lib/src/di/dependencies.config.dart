...
import 'package:template/src/dashboard/bloc/dashboard_authentication_cubit.dart'
    as _i25;
import 'package:template/src/dashboard/bloc/dashboard_cubit.dart' as _i26;
...
import 'package:template/src/screens/detail/bloc/detail_cubit.dart' as _i27;
...
import 'package:template/src/screens/detail/bloc/review_item_cubit.dart'
    as _i16;
import 'package:template/src/screens/guideline/bloc/help_cubit.dart' as _i28;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initDependencies({
    ...
    gh.factory<_i22.AddUniversityCubit>(
        () => _i22.AddUniversityCubit(gh<_i11.DetailRepository>()));
    ...
    gh.factory<_i25.DashboardAuthenticationCubit>(() =>
        _i25.DashboardAuthenticationCubit(gh<_i10.DashboardRepository>()));
    gh.factory<_i26.DashboardCubit>(
        () => _i26.DashboardCubit(gh<_i10.DashboardRepository>()));
    gh.factory<_i27.DetailCubit>(
        () => _i27.DetailCubit(gh<_i11.DetailRepository>()));
    gh.factory<_i28.HelpCubit>(() => _i28.HelpCubit(gh<_i21.UserRepository>()));
    gh.factory<_i29.ProfileCubit>(
        () => _i29.ProfileCubit(gh<_i21.UserRepository>()));
    gh.factory<_i30.SearchCubit>(
        () => _i30.SearchCubit(gh<_i17.SearchRepository>()));
    return this;
  }
}
