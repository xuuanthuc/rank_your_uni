...
import 'package:template/src/screens/compare/bloc/compare_cubit.dart' as _i14;
import 'package:template/src/screens/detail/bloc/detail_cubit.dart' as _i15;
...
import 'package:template/src/screens/search/bloc/search_cubit.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initDependencies({
    ...
    gh.factory<_i13.AutocompletionCubit>(
        () => _i13.AutocompletionCubit(gh<_i12.SearchRepository>()));
    gh.factory<_i14.CompareCubit>(
        () => _i14.CompareCubit(gh<_i7.DetailRepository>()));
    gh.factory<_i15.DetailCubit>(
        () => _i15.DetailCubit(gh<_i7.DetailRepository>()));
    gh.factory<_i16.SearchCubit>(
        () => _i16.SearchCubit(gh<_i12.SearchRepository>()));
    return this;
  }
}
