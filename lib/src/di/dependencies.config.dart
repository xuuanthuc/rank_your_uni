...
import 'package:template/src/dashboard/bloc/contact/dashboard_contact_item_cubit.dart'
    as _i30;
import 'package:template/src/dashboard/bloc/dashboard_cubit.dart' as _i31;
...
import 'package:template/src/repositories/user_repository.dart' as _i24;
import 'package:template/src/screens/add/bloc/add_cubit.dart' as _i25;
...
import 'package:template/src/screens/authentication/bloc/auth_form_cubit.dart'
    as _i7;
import 'package:template/src/screens/compare/bloc/compare_cubit.dart' as _i27;
...
import 'package:template/src/screens/detail/bloc/review_item_cubit.dart'
    as _i18;
import 'package:template/src/screens/guideline/bloc/help_cubit.dart' as _i35;
import 'package:template/src/screens/home/bloc/home_cubit.dart' as _i14;
import 'package:template/src/screens/profile/bloc/profile_cubit.dart' as _i36;
...
import 'package:template/src/screens/search/bloc/search_cubit.dart' as _i37;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initDependencies({
    ...
    gh.factory<_i24.UserRepository>(() => _i24.UserRepository());
    gh.factory<_i25.AddCubit>(() => _i25.AddCubit(gh<_i12.DetailRepository>()));
    gh.factory<_i4.AppSettingsBloc>(
        () => _i4.AppSettingsBloc(gh<_i24.UserRepository>()));
    gh.factory<_i26.AutocompletionCubit>(
        () => _i26.AutocompletionCubit(gh<_i19.SearchRepository>()));
    gh.factory<_i27.CompareCubit>(
        () => _i27.CompareCubit(gh<_i12.DetailRepository>()));
    gh.factory<_i28.DashboardAccountItemCubit>(
        () => _i28.DashboardAccountItemCubit(gh<_i10.DashboardRepository>()));
    gh.factory<_i29.DashboardAuthenticationCubit>(() =>
        _i29.DashboardAuthenticationCubit(gh<_i10.DashboardRepository>()));
    gh.factory<_i30.DashboardContactItemCubit>(
        () => _i30.DashboardContactItemCubit(gh<_i10.DashboardRepository>()));
    gh.factory<_i31.DashboardCubit>(
        () => _i31.DashboardCubit(gh<_i10.DashboardRepository>()));
    gh.factory<_i32.DashboardProfessorItemCubit>(
        () => _i32.DashboardProfessorItemCubit(gh<_i10.DashboardRepository>()));
    gh.factory<_i33.DashboardReportItemCubit>(
        () => _i33.DashboardReportItemCubit(gh<_i10.DashboardRepository>()));
    gh.factory<_i34.DetailProfessorCubit>(
        () => _i34.DetailProfessorCubit(gh<_i12.DetailRepository>()));
    gh.factory<_i35.HelpCubit>(() => _i35.HelpCubit(gh<_i24.UserRepository>()));
    gh.factory<_i36.ProfileCubit>(
        () => _i36.ProfileCubit(gh<_i24.UserRepository>()));
    gh.factory<_i37.SearchCubit>(
        () => _i37.SearchCubit(gh<_i19.SearchRepository>()));
    return this;
  }
}
