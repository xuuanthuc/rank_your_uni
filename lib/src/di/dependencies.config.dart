...
import 'package:template/global/storage/storage_provider.dart' as _i17;
...
import 'package:template/src/repositories/search_repository.dart' as _i15;
...
import 'package:template/src/screens/compare/bloc/compare_cubit.dart' as _i20;
import 'package:template/src/screens/detail/bloc/detail_cubit.dart' as _i21;
...
import 'package:template/src/screens/search/bloc/search_cubit.dart' as _i22;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initDependencies({
    ...
    gh.factory<_i14.ReviewItemCubit>(
        () => _i14.ReviewItemCubit(gh<_i8.DetailRepository>()));
    gh.factory<_i15.SearchRepository>(() => _i15.SearchRepository());
    gh.factory<_i16.SelectProvinceCubit>(() => _i16.SelectProvinceCubit());
    gh.lazySingleton<_i17.StorageProvider>(
        () => _i17.StorageProvider(gh<_i18.FlutterSecureStorage>()));
    gh.factory<_i19.AutocompletionCubit>(
        () => _i19.AutocompletionCubit(gh<_i15.SearchRepository>()));
    gh.factory<_i20.CompareCubit>(
        () => _i20.CompareCubit(gh<_i8.DetailRepository>()));
    gh.factory<_i21.DetailCubit>(
        () => _i21.DetailCubit(gh<_i8.DetailRepository>()));
    gh.factory<_i22.SearchCubit>(
        () => _i22.SearchCubit(gh<_i15.SearchRepository>()));
    return this;
  }
}
