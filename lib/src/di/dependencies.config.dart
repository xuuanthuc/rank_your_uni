...
import 'package:template/src/screens/detail/bloc/detail_cubit.dart' as _i13;
...
import 'package:template/src/screens/search/bloc/search_cubit.dart' as _i14;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initDependencies({
    ...
    gh.factory<_i13.DetailCubit>(
        () => _i13.DetailCubit(gh<_i7.DetailRepository>()));
    gh.factory<_i14.SearchCubit>(
        () => _i14.SearchCubit(gh<_i12.SearchRepository>()));
    return this;
  }
}
