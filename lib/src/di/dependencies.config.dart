...
import 'package:template/src/repositories/search_repository.dart' as _i12;
...
import 'package:template/src/screens/compare/bloc/compare_cubit.dart' as _i15;
import 'package:template/src/screens/detail/bloc/detail_cubit.dart' as _i16;
...
import 'package:template/src/screens/review/bloc/review_cubit.dart' as _i11;
import 'package:template/src/screens/search/bloc/search_cubit.dart' as _i17;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initDependencies({
    ...
    gh.factory<_i11.ReviewCubit>(
        () => _i11.ReviewCubit(gh<_i7.DetailRepository>()));
    gh.factory<_i12.SearchRepository>(() => _i12.SearchRepository());
    gh.factory<_i13.SelectProvinceCubit>(() => _i13.SelectProvinceCubit());
    gh.factory<_i14.AutocompletionCubit>(
        () => _i14.AutocompletionCubit(gh<_i12.SearchRepository>()));
    gh.factory<_i15.CompareCubit>(
        () => _i15.CompareCubit(gh<_i7.DetailRepository>()));
    gh.factory<_i16.DetailCubit>(
        () => _i16.DetailCubit(gh<_i7.DetailRepository>()));
