...
import 'package:template/src/screens/authentication/bloc/auth_form_cubit.dart'
    as _i8;
import 'package:template/src/screens/compare/bloc/compare_cubit.dart' as _i23;
import 'package:template/src/screens/detail/bloc/detail_cubit.dart' as _i24;
...
import 'package:template/src/screens/profile/bloc/profile_cubit.dart' as _i25;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initDependencies({
    ...
    gh.factory<_i5.AppSettingsBloc>(
        () => _i5.AppSettingsBloc(gh<_i21.UserRepository>()));
    gh.factory<_i22.AutocompletionCubit>(
        () => _i22.AutocompletionCubit(gh<_i17.SearchRepository>()));
    gh.factory<_i23.CompareCubit>(
        () => _i23.CompareCubit(gh<_i11.DetailRepository>()));
    gh.factory<_i24.DetailCubit>(
        () => _i24.DetailCubit(gh<_i11.DetailRepository>()));
    gh.factory<_i25.ProfileCubit>(
        () => _i25.ProfileCubit(gh<_i21.UserRepository>()));
    gh.factory<_i26.SearchCubit>(
        () => _i26.SearchCubit(gh<_i17.SearchRepository>()));
    return this;
  }
}
