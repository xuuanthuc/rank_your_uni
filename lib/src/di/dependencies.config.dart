...
import 'package:template/src/global_bloc/authentication/authentication_bloc.dart'
    as _i8;
import 'package:template/src/models/response/profile.dart' as _i9;
...
import 'package:template/src/screens/authentication/bloc/auth_form_cubit.dart'
    as _i6;
import 'package:template/src/screens/compare/bloc/compare_cubit.dart' as _i22;
import 'package:template/src/screens/detail/bloc/detail_cubit.dart' as _i23;
...
import 'package:template/src/screens/profile/bloc/profile_cubit.dart' as _i13;
import 'package:template/src/screens/review/bloc/review_cubit.dart' as _i15;
import 'package:template/src/screens/search/bloc/search_cubit.dart' as _i24;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initDependencies({
    ...
    gh.factory<_i8.AuthenticationState>(() => _i8.AuthenticationState(
          ...
          profileAuthenticated: gh<_i9.Profile>(),
        ));
    ...
    gh.factory<_i13.ProfileCubit>(
        () => _i13.ProfileCubit(gh<_i7.AuthRepository>()));
    gh.factory<_i14.ReportCubit>(
        () => _i14.ReportCubit(gh<_i10.DetailRepository>()));
    ...
    gh.factory<_i21.AutocompletionCubit>(
        () => _i21.AutocompletionCubit(gh<_i17.SearchRepository>()));
    gh.factory<_i22.CompareCubit>(
        () => _i22.CompareCubit(gh<_i10.DetailRepository>()));
    gh.factory<_i23.DetailCubit>(
        () => _i23.DetailCubit(gh<_i10.DetailRepository>()));
    gh.factory<_i24.SearchCubit>(
        () => _i24.SearchCubit(gh<_i17.SearchRepository>()));
    return this;
  }
}
