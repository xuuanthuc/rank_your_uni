          ...
          child: Container(
            ...
            child: const Column(
              ...
              children: [
                ...
                Gap(),
                DotLine(
                    'Nếu chúng tôi cung cấp dịch vụ đăng kí người dùng trên Rank Your UNi, để đăng kí làm thành viên của trang web, người dùng có thể có một số tuỳ chọn đăng kí (email, google mail), được mô tả trong chính sách quyền riêng tư'),
                Gap(),
                DotLine(
                    'Mỗi thành viên sẽ sử dụng tên đăng nhập và mật khẩu được đặt cùng với ID người dùng (ID này là duy nhất) để truy cập và sử dụng một số tính năng hoặc chức năng nhất định mà chúng tôi đã thiết kế cho người dùng'),
                Gap(),
                DotLine(
                    'Chúng tôi cũng có thể cung cấp cho người dùng mật khẩu mới hoặc mật khẩu bổ sung'),
                Gap(),
                DotLine(
                    'Xin vui lòng đọc chính sách quyền riêng tư của chúng tôi, nơi mà chúng tôi giải thích các thông tin mà chúng tôi thu thập, chia sẻ, quản lý, và lưu trữ'),
                Gap(),
                DotLine(
                ...
                Gap(),
                DotLine(
                    'Chúng tôi yêu cầu người dùng tôn trọng bản quyền, nhãn hiệu và các quyền sở hữu trí tuệ khác của chúng tôi. Ngược lại chúng tôi cũng tôn trọng các tài sản trí tuệ của người dung'),
                Gap(),
                DotLine(
                    'Trong trường hợp được thông báo, chúng tôi sẽ hành động nhanh chóng để xoá nội dung trên trang web mà vi phạm quyền bản quyền của người khác, đồng thời vô hiệu hoá quyền truy cập vào trang web và các dịch vụ vi phạm quyền sở hữu trí tuệ của người khác'),
                Gap(),
