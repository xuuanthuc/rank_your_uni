  ...
  Widget build(BuildContext context) {
    return const AppScaffold(
      ...
      children: [
        ...
        Gap(),
        DotLine(
            "Bất kể người dùng đang truy cập trang web của chúng mình thông qua bất kì thiết bị máy tính, di động hay thiết bị công nghệ nào khác đã được biết tới tính từ thời điểm hiện tại cho tới tương lai và được cho là “thiết bị“"),
        Gap(),
        DotLine(
        ...
        Gap(),
        NormalContent(
            "Website của chúng mình hướng tới được sử dụng bởi người dùng tại Việt Nam, và được quản lý và tuân theo pháp luật của Việt Nam. Nếu người dùng sử dụng website của chúng mình từ lãnh thổ khác ngoài Việt Nam, người dùng có thể phải chịu sự rủi ro và chúng mình không chịu trách nhiệm dưới luật pháp ngoài Việt Nam"),
        Gap(),
        NormalContent(
        ...
        Gap(),
        NormalContent(
            "Do đó, dựa trên phạm vi của phát luật cho phép, người dùng có thể từ bỏ mọi khiếu nại liên quan tới việc xử lý thông tin cá nhân, hoặc các thông tin khác đã được định nghĩa theo chính sách quyền riêng tư của chúng mình hoặc các điều luật liên quan tới chính sách quyền riêng tư ở bất kỳ quốc gia nào khác"),
        Gap(),
        ...
        Gap(),
        NormalContent(
            "Sau khi được cung cấp tài khoản, người dùng có thể sử dụng tài khoản được cung cấp để sử dụng website hoặc bất kì tính năng hoặc các dịch vụ được chúng mình cấp phép tới thời điểm hiện tại hoặc trong tương lai"),
        Gap(),
        NormalContent(
        ...
        Gap(),
        NormalContent(
            "Chúng mình có thể cung cấp cho người dùng một số quyền truy cập vào các tính năng hoặc chức năng nhất định. Ví dụ như việc tham gia bình luật, mua sắm hoặc hồ sơ thành viên.  Để có thể sử dụng các tính năng này, người dùng cần cung cấp một số thông tin nhất định để chúng mình có thể cá nhân hoá và cải thiện trải nghiệm của người dùng"),
        Gap(),
        DotLine(
            "Việc liên quan tới các chương trình tiếp thị, khuyến mãi"),
        Gap(),
        NormalContent(
            "Người dùng có thể phải cung cấp các thông tin như họ tên, ngày tháng năm sinh, địa chỉ, email, số điện thoại để tham dự các chương trình tiếp thị từ các đối tác của chúng mình trong lúc người dùng sử dụng trang web"),
        Gap(),
        NormalContent(
        ...
        Gap(),
        TitleContent("4. Cách mà chúng mình sử dụng thông tin của bạn"),
        Gap(),
        TitleContent("Các dữ liệu mà bạn cung cấp"),
        Gap(),
        NormalContent(
            "Chúng mình sử dụng dữ liệu cá nhân mà người dùng cung cấp dưới nhiều hình thức. Ví dụ như:"),
        Gap(),
        DotLine(
            "Gửi thử quảng cáo, chiến dịch quảng cáo, tin nhắn từ chúng mình hoặc bên thứ ba về những sản phẩm hoặc dịch vụ mà người dùng có thể quan tâm hoặc chú ý"),
        Gap(),
        DotLine(
            "Xác thực email đăng kí với chúng mình để chúng mình biết rằng email của người dùng là khả dụng"),
        Gap(),
        DotLine(
            "Liên hệ với người dùng và việc quản lý tài khoản của người dùng trong việc sử dụng các tính năng, chức năng mà người dùng đăng ký sử dụng, các khuyến mãi mà người dùng tham gia, giao dịch hoặc bất kì dịch vụ mà chúng mình cung cấp tới người dùng"),
        Gap(),
        DotLine(
            "Cho phép người dùng sử dụng trang web và các tính năng mà chúng mình mang lại"),
        Gap(),
        DotLine(
            "Liên hệ và trả lời bất kì những câu hỏi hoặc yêu cầu nào từ người dùng"),
        Gap(),
        DotLine(
            "Liên hệ về các thông tin mới (chức năng, điều khoản) mà trang web của chúng mình có thể cập nhật"),
        Gap(),
        DotLine(
            "Điều chỉnh trải nghiệm của người dùng về mặt nội dung hoặc những gì họ thấy khi truy cập trang"),
        Gap(),
        DotLine(
            "Điều chỉnh trải nghiệm liên quan tới ứng dụng hoặc dịch vụ được vận hành bởi chúng mình hoặc bên thứ ba"),
        Gap(),
        DotLine(
        ...
        Gap(),
        DotLine(
            "Từ chối các công nghệ theo dõi bằng cách sử dụng cơ chế từ chối có trong mỗi email hoặc các cơ chế khác mà chúng mình có thể cung cấp. Lưu ý, khi bạn chọn không tham gia nhận email, đồng nghĩa người dùng sẽ không tham gia vào các dịch vụ tiếp thị và quảng cáo sản phẩm mà chúng mình cung cấp trong tương lai"),
        Gap(),
        NormalContent(
        ...
        Gap(),
        TitleContent(
            'Việc chia sẽ và sử dụng thông tin. Chúng mình có thể chia sẻ thông tin cá nhân của người dùng đối với bên thứ ba dưới một vài trường hợp sau đây:'),
        Gap(),
        DotLine(
        ...
        Gap(),
        DotLine(
            "Chia sẻ và sử dụng các dịch vụ và tính năng bên thứ ba - đồng thương hiệu. Trang web cũng có thể cung cấp các dịch vụ và tính năng ví dụ như sự kiện hoặc khuyến mãi mà chúng mình kết hợp với bên thứ ba và có thể được lưu trữ và trên trang web và tổ chức bởi đối tác cùng nhãn hiệu. Đối tác cùng nhãn hiệu có trách nhiệm thông báo phương thức để người dùng có sự lựa chọn về việc không tham gia việc sử dụng thông tin cá nhân. Người dùng cần liên hệ trực tiếp đến các bên đồng thương hiệu và tuân thủ các chính sách mà bên thứ ba thiết lập"),
        Gap(),
        NormalContent(
            "Về việc sử dụng thông tin, bên thứ ba có thể sử dụng thông tin cá nhân để liên hệ với người dùng trong trường hợp cần xác minh và điều kiện nếu người dùng là một trong những người chiến thắng trong các chương trình mà chúng mình và bên thứ ba tổ chức"),
        Gap(),
        DotLine(
            "Chia sẻ cho các nhà cung cấp dịch vụ vận hành trang. Chúng mình có quyền chia sẻ thông tin dữ liệu cho các nhà cung cấp dịch vụ web (Operational Service Providers) với mục đích quản lý và vận hành trang web. Chúng mình sử dụng các nhà cung cấp dịch vụ web cho mục đích xây dựng trang, vận hành nội dung, hoạt động, xây dựng tính năng và các dịch vụ khác mà chúng mình mang tới người dùng"),
        Gap(),
        DotLine(
            "Chia sẻ cho một vài bên thứ ba nhất định. Bổ sung về việc chia sẻ thông tin, chúng mình sẽ cung cấp thông tin cá nhân của người dùng cho một số bên thứ ba nhất định trong các trường hợp hạn chế sau"),
        Gap(),
        Padding(
          ...
          child: Column(
            children: [
              DotLine(
                  "Khi chúng mình được yêu cầu bởi cơ quan chính phủ, toà án hoặc tổ chức có thẩm quyền của đất nước Việt Nam, nhằm đáp ứng phục vụ việc hầu toà, lệnh của toà án hoặc các thủ tục pháp lý như một phần của yêu cầu điều tra"),
              Gap(),
              DotLine(
                  "Nếu chúng mình tin rằng hành động của bạn vi phạm bất kỳ luật, quy tắc, quy định nào hoặc thỏa thuận điều khoản sử dụng, bao gồm nhưng không giới hạn ở chính sách quyền riêng tư này hoặc điều khoản bổ sung mà chúng mình đưa ra"),
              Gap(),
              DotLine(
              ...
              Gap(),
              DotLine(
                  "Nếu, theo quyết định riêng của chúng mình và chúng mình tin rằng việc tiết lộ đó là cần thiết hoặc phù hợp:"),
              Gap(),
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 30),
                child: Column(
              ...
              DotLine(
                  "Tiết lộ cho các danh nghiệp tiếp thị liên kết. Chúng mình có thể chia sẻ thông tin với các doanh nghiệp tiếp thị liên kết hoặc cơ sở kinh doanh khác của Rank Your UNi. Chúng mình làm điều này để cung cấp hoặc cải thiện dịch vụ"),
              Gap(),
        ...
        NormalContent(
            'Chia sẻ và tiết lộ thông tin không được xác định danh tính. Chúng mình có thể chia sẻ Thông tin không xác định với hoặc tiết lộ Thông tin không xác định cho các bên thứ ba, nhưng chúng mình không tiết lộ Thông tin cá nhân cho họ ngoại trừ những thông tin được mô tả trong Chính sách quyền riêng tư này'),
        Gap(),
        TitleContent(
        ...
        Gap(),
        DotLine(
            'Hạn chế. Một số thông tin nhất định được thu thập trong lúc người dùng tham gia vào các chương trình khuyến mãi hoặc dịch vụ của chúng mình sẽ phải tuân theo các yêu cầu về việc lưu trữ thông tin, hồ sơ của người dùng và sẽ không bị xoá theo yêu câu của người dùng, trừ khi người dùng dưới 16 tuổi hoặc các trường hợp nhất định khác'),
        Gap(),
        DotLine(
            'Những đối tượng không được khuyến khích sử dụng trang. Người dùng của chúng mình được khuyến cáo phải ít nhất từ 17 tuổi để sử dụng trang. Nếu chúng mình vô tình gửi email hoặc tin nhắn văn bản cho một số người dùng không đáp ứng về các yêu cầu về độ tuổi hoặc các điều kiện khác (người dưới 17 tuổi). Người bảo hộ (ví dụ: phụ huynh), có thể huỷ đăng kí hoặc lựa chọn không tham gia nhận email thông qua cơ chế huỷ đăng kí trong email hoặc tin nhắn hoặc các quy trình huỷ đăng kí tương tự mà chúng mình nêu ở phía trên'),
        Gap(),
        NormalContent(
            'Ngoài ra, việc chấm dứt tư cách thành viên do không đủ điều kiện về độ tuổi. Người dùng cần sử dụng thẻ căn cước để xác minh quyền truy cập trực tiếp vào tài khoản và làm theo các quy trình. Hãy liên hệ với chúng mình qua trang web, tại phần liên hệ'),
        Gap(),
        ...
        Gap(),
        DotLine(
            'Là hình thức tấn công mạng mà kẻ tấn công giả mạo chúng mình (RYU) để lừa đảo người dùng cung cấp thông tin cá nhân cho kẻ lừa đảo. Phương thức này thường được tin tặc thực hiện thông qua email và tin nhắn. Người dùng khi mở các email, hoặc đường link giả mạo này có thể sẽ được yêu cầu cung cấp các thông tin cá nhân nhạy cảm như: tài khoản & mật khẩu, mật khẩu giao dịch, thẻ tín dụng hoặc các thông tin quý giá khác'),
        Gap(),
        NormalContent(
            'CHÚNG MÌNH KHÔNG GỬI EMAIL YÊU CẦU BẠN CUNG CẤP HOẶC XÁC NHẬN CÁC THÔNG TIN LIÊN QUAN TỚI SỐ THẺ TÍN DỤNG, MẬT KHẨU CỦA NGƯỜI DÙNG!'),
        Gap(),
        NormalContent(
            'Nếu bạn nhận được thông tin liên lạc qua email như vậy không làm theo. Vui lòng liên hệ với chúng mình qua địa chỉ email rankyouruni@outlook.com'),
        Gap(),
        TitleContent(
            '9. Chính sách bảo mật này giải thích các Rank Your UNi thu thập, sử dụng, chia sẻ dữ liệu cá nhân của bạn khi sử dụng trang web của chúng mình hoặc tương tác với website. Dữ liệu cá nhân là bất kì thông tin nào về người dùng dùng để nhận dạng. Bao gồm các thông tin như:'),
        Gap(),
        ...
        Gap(),
        DotLine(
            'Thay đổi chính sách và quyền riêng tư. Chúng mình hoàn toàn có quyền thay đổi, sửa đổi chính sách quyền riêng tư này bất kì lúc nào vì bất kì lý do gì mà không cần cập nhập hoặc thông báo trước cho người dùng. Những sửa đổi như vậy sẽ có hiệu lực ngay khi đăng và áp dụng với người dùng'),
        Gap(),
        DotLine(
            'Chúng mình sẽ hiển thị những thông báo về những thay đổi quan trọng trên trang chủ hoặc trang web hoặc email để thông báo cho người dùng đã được đăng kí về những thay đổi này'),
        Gap(),
        DotLine(
            'Chúng mình khuyến khích người dùng thường xuyên ghé thăm chính sách quyền riêng tư và thoả thuận điều khoản sử dụng để cập nhật những thông tin mới nhất'),
        Gap(),
        NormalContent(
