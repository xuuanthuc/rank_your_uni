...
import 'package:template/src/screens/search/widgets/professor_card.dart';
...
class SearchProfessorResultsView extends StatelessWidget {
  const SearchProfessorResultsView({super.key});
